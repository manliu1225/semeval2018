...
class BiLSTMClassifier(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, MAX_VOCAB_SIZE = 2000, BATCH_SIZE = 128, EPOCHS = 3, MAX_LENGTH = 50, EMBED_SIZE = 4000):
    ...
    def fit(self, X, y):
        ...
        # self.model.add(Bidirectional(LSTM(units=64, dropout=0.2, recurrent_dropout=0.2), input_shape=(X.shape[1], 1, self.EMBED_SIZE)))
